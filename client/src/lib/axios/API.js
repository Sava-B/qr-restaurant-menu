...
export const createRestaurants = (data, token) =>
	API.post("/private/restaurants", data, { headers: authHeader(token) });
export const updateRestaurants = (id, data, token) =>
	API.put(`/private/restaurants/${id}`, data, {
		headers: authHeader(token),
	});
export const deleteRestaurants = (id, token) =>
	API.delete(`/private/restaurants/${id}`, { headers: authHeader(token) });
